 ...
 * response to the {@link net.dv8tion.jda.api.entities.channel.middleman.MessageChannel MessageChannel} the MessageReceivedEvent was in.
...
public class CommandEvent
{
     ...
     * {@link net.dv8tion.jda.api.entities.channel.middleman.MessageChannel#sendMessage(MessageCreateData) MessageChannel#sendMessage()}
     ...
     * automatically does {@link net.dv8tion.jda.api.requests.RestAction#queue() RestAction#queue()}.
     * 
     * <p>This method uses {@link net.dv8tion.jda.api.entities.channel.middleman.MessageChannel#sendFiles(FileUpload...) MessageChannel#sendFile(FileUpload...)}
     ...
     * {@link net.dv8tion.jda.api.entities.channel.middleman.MessageChannel MessageChannel} that the CommandEvent was triggered on.
     * 
     ...
     *         
     * @return {@code true} if the CommandEvent originated from a {@link net.dv8tion.jda.api.entities.channel.middleman.MessageChannel}
